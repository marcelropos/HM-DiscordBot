...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        if ctx.invoked_subcommand is None:
            embed = discord.Embed(title="Hilfsübersicht",
            ...
            embed.add_field(name="Regeln:",
                            value="Auch auf diesem Server gibt es Regeln, diese findest du, indem du mir ```!rules``` "
                                  "schreibst.")
    ...
    async def my_data(self, ctx):
        embed = discord.Embed(title="Datenschutz",
                              colour=discord.Colour(0x12d4ca),
    ...
    async def roles(self, ctx):
        ...
        embed.add_field(name="Falsche(r) Studiengang/Gruppe",
                        value="```Deine Rolle kann nur vom Admin entfernt werden```")

        embed.add_field(name="NSFW",
                        value="Mit `!nsfw-add` oder `#nsfw-rem` kannst du dir die Rolle für den Channel: "
                              "<#766307455856410634> geben.",
                        inline=False)

        embed.add_field(name="Bot Coder",
                        value="Mit `!coding` kannst du teil des Botcoding Teams werden.",
                        inline=False)
    ...
    async def tmpc(self, ctx):
        embed = discord.Embed(title="Temporäre Channel",
                              colour=discord.Colour(0x12d4ca),
        ...
        embed.add_field(name="Schritt 1",
                        value="Verbinde dich mit einem belibigen Voicechannel des Discord Servers.",
                        inline=False)

        embed.add_field(name="Schritt 2",
                        value="`!tmpc {Name des Channels}`",
                        inline=False)
        embed.add_field(name="Schritt 3",
                        value="Du wirst nun in diesen Channel gezogen. In dem dazugehörigen Textchannel erhälst du "
                              "einen Token.  Dieser Token ist der Zugangsschlüssel für deine erstellten Channel.",
                        inline=False)
        ...
        embed.add_field(name="Schritt 6",
                        value="Alle verlassen den Channel, der Channel wird gelöscht",
                        inline=False)
